...
const Hero: FC = memo(() => {
  ...
  return (
    <Section className={'bg-black bg-gradient-to-r from-sky-950 to-indigo-900'} noPadding sectionId={SectionId.Hero}>
      <div className="relative flex h-screen w-screen items-center justify-center">
        ...
        <div className="z-10  max-w-screen-lg px-4 lg:px-0">
          <div className="flex flex-col items-center gap-y-6 rounded-xl bg-gray-800/40 p-6 text-center shadow-xl backdrop-blur-sm">
            <h1 className="text-4xl font-bold text-slate-200 sm:text-5xl lg:text-7xl">{name}</h1>
            {description}
            <div className="flex gap-x-4 text-neutral-50 dark:text-white">
              <Socials />
            </div>
